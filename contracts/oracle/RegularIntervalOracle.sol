...
contract RegularIntervalOracle is RegularIntervalOracleInterface {
    ...
    constructor(
        ...
        require(
            initialDataNum > 1,
            "Error: InitialDataNum should be more than 1"
        );
        // AUDIT-FIX: RIO-12
        require(
        ...
        returns (bool)
    {
        ...
        _regularIntervalPriceData[_latestTimestamp]
            .ewmaVolatilityE8 = updatedVol.toUint64();
        // AUDIT-FIX: RIO-21
        ...
        returns (bool)
    {
        ...
        require(
            quantsAddress != address(0),
            "Error: Invalid new quant address"
        );
        // AUDIT-FIX: RIO-27
    ...
    {
        return
            _getValidRoundIDWithAggregator(
                hintID,
                targetTimeStamp,
                _chainlinkOracle
            );
